...

{
  ...
  border:1px solid #ccc; background-color:#fda;
  `;

  const elConPar = elConPart.querySelectorAll('p');//querySelector : 하나만 선택됨.
  ...
  elConPar.forEach((el , idx )=>{
    el.style = style1;
    // console.log(el.childNodes[0]); // 다양한 요소
    console.log(el.parentNode); // 부모의요소를 찾아줌
  });
