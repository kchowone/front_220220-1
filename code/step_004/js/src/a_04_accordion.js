...
/** // 시나리오 : 아코디언 메뉴를 형성
 *  1. dt(button)을 클릭시, 뒤에오는 dd를 나타나게 만들자!
 *  2. dt를 클릭시 dd가 나타나는데 다른 dl에 있는 dd는 사라지게 만들자! (선택순번/다른순번을 체크)
 *  3. dd를 나타나게 만들때 animation을 적용해 주세요. (펼쳤을 경우의 높이값이 필요. : 0값 -> 적용높이값까지 움직임을 수행)
...
const fnSlideDown = function(el,n){
  ...
  elDd.style= `height:0; overflow:hidden;
